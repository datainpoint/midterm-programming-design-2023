...
class TestMidterm(unittest.TestCase):
    ...
    def test_02_return_days_abbreviation(self):
    ...
    def test_04_return_months_abbreviation_from_int(self):
        self.assertEqual(asgmt.return_months_abbreviation_from_int(1), ('January', 'Jan.'))
        self.assertEqual(asgmt.return_months_abbreviation_from_int(2), ('February', 'Feb.'))
        self.assertEqual(asgmt.return_months_abbreviation_from_int(3), ('March', 'Mar.'))
        self.assertEqual(asgmt.return_months_abbreviation_from_int(11), ('November', 'Nov.'))
        self.assertEqual(asgmt.return_months_abbreviation_from_int(12), ('December', 'Dec.'))
